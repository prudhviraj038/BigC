        ...
        next_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i < exams.questions.size()) {
                    ...
                    Set_option(Integer.parseInt(exams.questions.get(i).result),Integer.parseInt(exams.questions.get(i).correct));
...
next_ll.performClick();
    ...
    public  void Set_option(int i,int j){
        ...
        switch (j){
            case 1:
                a.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                a.setTextColor(Color.parseColor("#ffffff"));
                ans1.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                ans1.setTextColor(Color.parseColor("#ffffff"));
                break;
            case 2:
                b.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                b.setTextColor(Color.parseColor("#ffffff"));
                ans2.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                ans2.setTextColor(Color.parseColor("#ffffff"));
                break;
            case 3:
                c.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                c.setTextColor(Color.parseColor("#ffffff"));
                ans3.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                ans3.setTextColor(Color.parseColor("#ffffff"));
                break;
            case 4:
                d.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                d.setTextColor(Color.parseColor("#ffffff"));
                ans4.setBackgroundResource(R.drawable.examreviewrounded_green_corners);
                ans4.setTextColor(Color.parseColor("#ffffff"));
                break;
        }
    }
